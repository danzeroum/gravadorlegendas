...
# No Linux/Wayland, 'Sans Serif' resolve para a fonte bitmap 'fixed' (apenas 10pt).
# Usamos 'liberation sans' (disponível no Fedora) que escala corretamente.
FONT_FAMILY = "liberation sans"
FONT_FAMILY_MONO = "liberation mono"
...
def apply_widget_scaling(factor: float) -> None:
    ...
    proporcoes corretas. Em Windows o sistema gerencia HiDPI, entao
    usamos o widget_scaling do usuário com janela em 1.0.
    """
    if sys.platform.startswith("linux"):
...
class Theme:
    ...
    TOAST_QUESTION_BG = ("#FEF3C7", "#78350F")
    TOAST_QUESTION_TEXT = ("#78350F", "#FEF3C7")
    TOAST_INFO_BG = ("#DBEAFE", "#1E3A5F")
    TOAST_INFO_TEXT = ("#1E3A5F", "#DBEAFE")
...
def install_focus_ring(widget) -> None:
    ...
    em widgets sem suporte a borda ou bind.
    """
    try:
    ...
    try:
        ...
        # Widget não suporta bind (ex.: CTkSegmentedButton)
        pass
